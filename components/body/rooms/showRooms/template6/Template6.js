...
import SingleRoom from 'components/body/rooms/showRooms/template6/SingleRoom'
            ...
            <div className="rooms-container-inner w-100">
                ...
                <div className="content row justify-content-center align-self-center gutters">
                    {rooms && rooms.map((room, index) => {
                        return(
                            <div key={index} className="image-container col-xl-12 col-12">
                                <SingleRoom room={room} css={css} number={index+1} position={index % 2 === 1 ? 'left' : 'right' }/>
                            </div>
                        )
                    })}
                </div>
