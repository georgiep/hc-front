...
import SingleRoom from 'components/body/rooms/showRooms/template1/SingleRoom'
        ...
        <div className="rooms-container-outer d-flex justify-content-center">
            <div className="rooms-container-inner w-100">
                <div className="inner d-flex">
                    <div>
                        <div className="title">
                            <Heading text={title} headingLevel={'2'} css={css.title} />
                        </div>
                        <div className="subtitle">
                            <Heading text={subtitle} headingLevel={'3'} css={css.subtitle} />
                        </div>
                    </div>
                    <div className="d-flex justify-content-end">
                        <div className="all-rooms ">
                            <Button buttonStyle={'btn underline-on-hover'} button={button} css={css.button} />
                        </div>
                    </div>
                </div>
